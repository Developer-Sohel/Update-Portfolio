...
export const About = () => {
	...
	<div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row gap-28">
		<div className="flex items-center justify-center p-6 mt-8 lg:mt-0 h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128">
			<img src={sohel} className='shadow-2xl rounded-md shadow-red-300' alt=""  />
		</div>
		<div className="flex flex-col justify-center text-center rounded-sm lg:w-1/2 space-y-2.5 lg:text-left">
