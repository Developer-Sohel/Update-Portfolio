...
const Education = () => {
  const educationData = [
    ...
    // },
    {
      ...
      university: 'Dighol Haila DS Dhakil Madrasha',
      dates: '2017 - 2020',
      description: 'I successfully completed my Secondary School Certificate (SSC) examinations in 2020.  This achievement marked a significant step in my academic journey and provided a solid base for my higher secondary studies.  I am now building upon this foundation as I pursue my further education and career goals.',
    },
    
    {
      degree: 'Digital Merketer',
      university: 'Digital maeketing IT',
      dates: '2025- Present',
      description: 'I am a full-service digital marketing expert, skilled in Google Ads, Facebook Ads, SEO, content marketing, and social media management. Proficient in creating integrated strategies to drive traffic, engagement, and conversions across platforms. Dedicated to delivering measurable results and helping businesses achieve their online growth goals.',
    },
